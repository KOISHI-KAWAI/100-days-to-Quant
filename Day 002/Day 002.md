...
通常我们可以通过 pandas-ta, 或者 tal ib 库来构造主观的量价数据指标，由于后者更贴合生产环境，因此如下代码和演示均使用talib. (参考文档: [Technical Analysis Library in Python](https://technical-analysis-library-in-python.readthedocs.io/en/latest/index.html)) 
